...
$output["result"] = 0;
$output["error"] = "";
$output["service_index"] = $TEMP_SERVICE_INDEX;
$output["service_id"] = $service_id;
$output["service_email"] = $TEMP_SERVICE_EMAIL;
$output["service_key"] = $TEMP_SERVICE_KEY;
$output["service_called"] = $TEMP_SERVICE_CALLED;
$output["service_created"] = $TEMP_SERVICE_CREATED;
$output["service_expire"] = $TEMP_SERVICE_EXPIRE;
$outputJson = json_encode($output);
echo urldecode($outputJson);
